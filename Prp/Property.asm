...
szTrue				db 'True',0
;False/True Styles
SysMDlg				dd 0FFFFFFFFh xor WS_SYSMENU,0
					dd 0FFFFFFFFh xor WS_SYSMENU,WS_SYSMENU
MaxBDlg				dd 0FFFFFFFFh xor WS_MAXIMIZEBOX,0
					dd 0FFFFFFFFh xor WS_MAXIMIZEBOX,WS_MAXIMIZEBOX
MinBDlg				dd 0FFFFFFFFh xor WS_MINIMIZEBOX,0
					dd 0FFFFFFFFh xor WS_MINIMIZEBOX,WS_MINIMIZEBOX
EnabAll				dd 0FFFFFFFFh xor WS_DISABLED,WS_DISABLED
					dd 0FFFFFFFFh xor WS_DISABLED,0
VisiAll				dd 0FFFFFFFFh xor WS_VISIBLE,0
					dd 0FFFFFFFFh xor WS_VISIBLE,WS_VISIBLE
DefaBtn				dd 0FFFFFFFFh xor BS_DEFPUSHBUTTON,0
					dd 0FFFFFFFFh xor BS_DEFPUSHBUTTON,BS_DEFPUSHBUTTON
AutoChk				dd 0FFFFFFFFh xor (BS_AUTOCHECKBOX or BS_CHECKBOX),BS_CHECKBOX
					dd 0FFFFFFFFh xor (BS_AUTOCHECKBOX or BS_CHECKBOX),BS_AUTOCHECKBOX
AutoRbt				dd 0FFFFFFFFh xor (BS_AUTORADIOBUTTON or BS_RADIOBUTTON),BS_RADIOBUTTON
					dd 0FFFFFFFFh xor (BS_AUTORADIOBUTTON or BS_RADIOBUTTON),BS_AUTORADIOBUTTON
AutoCbo				dd 0FFFFFFFFh xor CBS_AUTOHSCROLL,0
					dd 0FFFFFFFFh xor CBS_AUTOHSCROLL,CBS_AUTOHSCROLL
AutoSpn				dd 0FFFFFFFFh xor UDS_AUTOBUDDY,0
					dd 0FFFFFFFFh xor UDS_AUTOBUDDY,UDS_AUTOBUDDY
AutoTbr				dd 0FFFFFFFFh xor CCS_NORESIZE,CCS_NORESIZE 
					dd 0FFFFFFFFh xor CCS_NORESIZE,0
AutoAni				dd 0FFFFFFFFh xor ACS_AUTOPLAY,0
					dd 0FFFFFFFFh xor ACS_AUTOPLAY,ACS_AUTOPLAY
MnemStc				dd 0FFFFFFFFh xor SS_NOPREFIX,SS_NOPREFIX
					dd 0FFFFFFFFh xor SS_NOPREFIX,0
WordStc				dd 0FFFFFFFFh xor (SS_LEFTNOWORDWRAP or SS_CENTER or SS_RIGHT),SS_LEFTNOWORDWRAP
					dd 0FFFFFFFFh xor (SS_LEFTNOWORDWRAP or SS_CENTER or SS_RIGHT),0
MultEdt				dd 0FFFFFFFFh xor ES_MULTILINE,0
					dd 0FFFFFFFFh xor ES_MULTILINE,ES_MULTILINE
MultBtn				dd 0FFFFFFFFh xor BS_MULTILINE,0
					dd 0FFFFFFFFh xor BS_MULTILINE,BS_MULTILINE
MultTab				dd 0FFFFFFFFh xor TCS_MULTILINE,0
					dd 0FFFFFFFFh xor TCS_MULTILINE,TCS_MULTILINE
MultLst				dd 0FFFFFFFFh xor (LBS_MULTIPLESEL or LBS_EXTENDEDSEL),0
					dd 0FFFFFFFFh xor (LBS_MULTIPLESEL or LBS_EXTENDEDSEL),LBS_MULTIPLESEL or LBS_EXTENDEDSEL
MultMvi				dd 0FFFFFFFFh xor MCS_MULTISELECT,0
					dd 0FFFFFFFFh xor MCS_MULTISELECT,MCS_MULTISELECT
LockEdt				dd 0FFFFFFFFh xor ES_READONLY,0
					dd 0FFFFFFFFh xor ES_READONLY,ES_READONLY
ChilAll				dd 0FFFFFFFFh xor WS_CHILD,0
					dd 0FFFFFFFFh xor WS_CHILD,WS_CHILD
SizeDlg				dd 0FFFFFFFFh xor WS_SIZEBOX,0
					dd 0FFFFFFFFh xor WS_SIZEBOX,WS_SIZEBOX
SizeSbr				dd 0FFFFFFFFh xor SBARS_SIZEGRIP,0
					dd 0FFFFFFFFh xor SBARS_SIZEGRIP,SBARS_SIZEGRIP
TabSAll				dd 0FFFFFFFFh xor WS_TABSTOP,0
					dd 0FFFFFFFFh xor WS_TABSTOP,WS_TABSTOP
NotiStc				dd 0FFFFFFFFh xor SS_NOTIFY,0
					dd 0FFFFFFFFh xor SS_NOTIFY,SS_NOTIFY
NotiBtn				dd 0FFFFFFFFh xor BS_NOTIFY,0
					dd 0FFFFFFFFh xor BS_NOTIFY,BS_NOTIFY
NotiLst				dd 0FFFFFFFFh xor LBS_NOTIFY,0
					dd 0FFFFFFFFh xor LBS_NOTIFY,LBS_NOTIFY
WantEdt				dd 0FFFFFFFFh xor ES_WANTRETURN,0
					dd 0FFFFFFFFh xor ES_WANTRETURN,ES_WANTRETURN
SortCbo				dd 0FFFFFFFFh xor CBS_SORT,0
					dd 0FFFFFFFFh xor CBS_SORT,CBS_SORT
SortLst				dd 0FFFFFFFFh xor LBS_SORT,0
					dd 0FFFFFFFFh xor LBS_SORT,LBS_SORT
FlatTbr				dd 0FFFFFFFFh xor TBSTYLE_FLAT,0
					dd 0FFFFFFFFh xor TBSTYLE_FLAT,TBSTYLE_FLAT
GrouAll				dd 0FFFFFFFFh xor WS_GROUP,0
					dd 0FFFFFFFFh xor WS_GROUP,WS_GROUP
UseTLst				dd 0FFFFFFFFh xor LBS_USETABSTOPS,0
					dd 0FFFFFFFFh xor LBS_USETABSTOPS,LBS_USETABSTOPS
SetBUdn				dd 0FFFFFFFFh xor UDS_SETBUDDYINT,0
					dd 0FFFFFFFFh xor UDS_SETBUDDYINT,UDS_SETBUDDYINT
HideEdt				dd 0FFFFFFFFh xor ES_NOHIDESEL,ES_NOHIDESEL
					dd 0FFFFFFFFh xor ES_NOHIDESEL,0
HideTrv				dd 0FFFFFFFFh xor TVS_SHOWSELALWAYS,TVS_SHOWSELALWAYS
					dd 0FFFFFFFFh xor TVS_SHOWSELALWAYS,0
HideLsv				dd 0FFFFFFFFh xor LVS_SHOWSELALWAYS,LVS_SHOWSELALWAYS
					dd 0FFFFFFFFh xor LVS_SHOWSELALWAYS,0
IntHtCbo			dd 0FFFFFFFFh xor CBS_NOINTEGRALHEIGHT,CBS_NOINTEGRALHEIGHT
					dd 0FFFFFFFFh xor CBS_NOINTEGRALHEIGHT,0
IntHtLst			dd 0FFFFFFFFh xor LBS_NOINTEGRALHEIGHT,LBS_NOINTEGRALHEIGHT
					dd 0FFFFFFFFh xor LBS_NOINTEGRALHEIGHT,0
ButtTab				dd 0FFFFFFFFh xor TCS_BUTTONS,0
					dd 0FFFFFFFFh xor TCS_BUTTONS,TCS_BUTTONS
ButtTrv				dd 0FFFFFFFFh xor TVS_HASBUTTONS,0
					dd 0FFFFFFFFh xor TVS_HASBUTTONS,TVS_HASBUTTONS
ButtHdr				dd 0FFFFFFFFh xor HDS_BUTTONS,0
					dd 0FFFFFFFFh xor HDS_BUTTONS,HDS_BUTTONS
PopUAll				dd 0FFFFFFFFh xor WS_POPUP,0
					dd 0FFFFFFFFh xor WS_POPUP,WS_POPUP
OwneBtn				dd 0FFFFFFFFh xor BS_OWNERDRAW,0
					dd 0FFFFFFFFh xor BS_OWNERDRAW,BS_OWNERDRAW
OwneLsv				dd 0FFFFFFFFh xor LVS_OWNERDRAWFIXED,0
					dd 0FFFFFFFFh xor LVS_OWNERDRAWFIXED,LVS_OWNERDRAWFIXED
TranAni				dd 0FFFFFFFFh xor ACS_TRANSPARENT,0
					dd 0FFFFFFFFh xor ACS_TRANSPARENT,ACS_TRANSPARENT
TimeAni				dd 0FFFFFFFFh xor ACS_TIMER,0
					dd 0FFFFFFFFh xor ACS_TIMER,ACS_TIMER
WeekMvi				dd 0FFFFFFFFh xor MCS_WEEKNUMBERS,0
					dd 0FFFFFFFFh xor MCS_WEEKNUMBERS,MCS_WEEKNUMBERS
ToolTbr				dd 0FFFFFFFFh xor TBSTYLE_TOOLTIPS,0
					dd 0FFFFFFFFh xor TBSTYLE_TOOLTIPS,TBSTYLE_TOOLTIPS
ToolTab				dd 0FFFFFFFFh xor TCS_TOOLTIPS,0
					dd 0FFFFFFFFh xor TCS_TOOLTIPS,TCS_TOOLTIPS
WrapTbr				dd 0FFFFFFFFh xor TBSTYLE_WRAPABLE,0
					dd 0FFFFFFFFh xor TBSTYLE_WRAPABLE,TBSTYLE_WRAPABLE
DiviTbr				dd 0FFFFFFFFh xor CCS_NODIVIDER,CCS_NODIVIDER
					dd 0FFFFFFFFh xor CCS_NODIVIDER,0
DragHdr				dd 0FFFFFFFFh xor HDS_DRAGDROP,0
					dd 0FFFFFFFFh xor HDS_DRAGDROP,HDS_DRAGDROP
SmooPgb				dd 0FFFFFFFFh xor PBS_SMOOTH,0
					dd 0FFFFFFFFh xor PBS_SMOOTH,PBS_SMOOTH
HasStcb				dd 0FFFFFFFFh xor CBS_HASSTRINGS,0
					dd 0FFFFFFFFh xor CBS_HASSTRINGS,CBS_HASSTRINGS
HasStlb				dd 0FFFFFFFFh xor LBS_HASSTRINGS,0
					dd 0FFFFFFFFh xor LBS_HASSTRINGS,LBS_HASSTRINGS

;False/True ExStyles
TopMost				dd 0FFFFFFFFh xor WS_EX_TOPMOST,0
					dd 0FFFFFFFFh xor WS_EX_TOPMOST,WS_EX_TOPMOST

;Multi styles
ClipAll				db 'None,Children,Siblings,Both',0
					dd 0FFFFFFFFh xor (WS_CLIPCHILDREN or WS_CLIPSIBLINGS),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (WS_CLIPCHILDREN or WS_CLIPSIBLINGS),WS_CLIPCHILDREN
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (WS_CLIPCHILDREN or WS_CLIPSIBLINGS),WS_CLIPSIBLINGS
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (WS_CLIPCHILDREN or WS_CLIPSIBLINGS),WS_CLIPCHILDREN or WS_CLIPSIBLINGS
					dd 0FFFFFFFFh,0
ScroAll				db 'None,Horizontal,Vertical,Both',0
					dd 0FFFFFFFFh xor (WS_HSCROLL or WS_VSCROLL),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (WS_HSCROLL or WS_VSCROLL),WS_HSCROLL
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (WS_HSCROLL or WS_VSCROLL),WS_VSCROLL
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (WS_HSCROLL or WS_VSCROLL),WS_HSCROLL or WS_VSCROLL
					dd 0FFFFFFFFh,0
AligStc				db 'TopLeft,TopCenter,TopRight,CenterLeft,CenterCenter,CenterRight',0
					dd 0FFFFFFFFh xor (SS_CENTER or SS_RIGHT or SS_CENTERIMAGE),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (SS_CENTER or SS_RIGHT or SS_CENTERIMAGE),SS_CENTER
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (SS_CENTER or SS_RIGHT or SS_CENTERIMAGE),SS_RIGHT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (SS_CENTER or SS_RIGHT or SS_CENTERIMAGE),SS_CENTERIMAGE
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (SS_CENTER or SS_RIGHT or SS_CENTERIMAGE),SS_CENTER or SS_CENTERIMAGE
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (SS_CENTER or SS_RIGHT or SS_CENTERIMAGE),SS_RIGHT or SS_CENTERIMAGE
					dd 0FFFFFFFFh,0
AligEdt				db 'Left,Center,Right',0
					dd 0FFFFFFFFh xor (ES_CENTER or ES_RIGHT),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_CENTER or ES_RIGHT),ES_CENTER
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_CENTER or ES_RIGHT),ES_RIGHT
					dd 0FFFFFFFFh,0
AligBtn				db 'Default,TopLeft,TopCenter,TopRight,CenterLeft,CenterCenter,CenterRight,BottomLeft,BottomCenter,BottomRight',0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_TOP or BS_LEFT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_CENTER or BS_TOP
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_TOP or BS_RIGHT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_LEFT or BS_VCENTER
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_CENTER or BS_VCENTER
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_RIGHT or BS_VCENTER
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_BOTTOM or BS_LEFT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_CENTER or BS_BOTTOM
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_CENTER or BS_VCENTER),BS_BOTTOM or BS_RIGHT
					dd 0FFFFFFFFh,0
AligChk				db 'Left,Right',0
					dd 0FFFFFFFFh xor (BS_LEFTTEXT),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_LEFTTEXT),BS_LEFTTEXT
					dd 0FFFFFFFFh,0
AligTab				db 'Left,Top,Right,Bottom',0
					dd 0FFFFFFFFh xor (TCS_BOTTOM or TCS_VERTICAL),TCS_VERTICAL
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (TCS_BOTTOM or TCS_VERTICAL),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (TCS_BOTTOM or TCS_VERTICAL),TCS_BOTTOM or TCS_VERTICAL
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (TCS_BOTTOM or TCS_VERTICAL),TCS_BOTTOM
					dd 0FFFFFFFFh,0
AligLsv				db 'Left,Top',0
					dd 0FFFFFFFFh xor LVS_ALIGNLEFT,LVS_ALIGNLEFT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor LVS_ALIGNLEFT,0
					dd 0FFFFFFFFh,0
AligSpn				db 'None,Left,Right',0
					dd 0FFFFFFFFh xor (UDS_ALIGNLEFT or UDS_ALIGNRIGHT),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (UDS_ALIGNLEFT or UDS_ALIGNRIGHT),UDS_ALIGNLEFT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (UDS_ALIGNLEFT or UDS_ALIGNRIGHT),UDS_ALIGNRIGHT
					dd 0FFFFFFFFh,0
AligIco				db 'AutoSize,Center',0
					dd 0FFFFFFFFh xor SS_CENTERIMAGE,0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor SS_CENTERIMAGE,SS_CENTERIMAGE
					dd 0FFFFFFFFh,0
AligTbr				db 'Left,Top,Right,Bottom',0
					dd 0FFFFFFFFh xor (CCS_VERT or CCS_BOTTOM or CCS_TOP),CCS_TOP or CCS_VERT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (CCS_VERT or CCS_BOTTOM or CCS_TOP),CCS_TOP
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (CCS_VERT or CCS_BOTTOM or CCS_TOP),CCS_BOTTOM or CCS_VERT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (CCS_VERT or CCS_BOTTOM or CCS_TOP),CCS_BOTTOM
					dd 0FFFFFFFFh,0
AligAni				db 'AutoSize,Center',0
					dd 0FFFFFFFFh xor ACS_CENTER,0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor ACS_CENTER,ACS_CENTER
					dd 0FFFFFFFFh,0
BordDlg				db 'Flat,Boarder,Dialog,Tool,ModalFrame',0
					dd 0FFFFFFFFh xor (WS_DLGFRAME or WS_BORDER or DS_MODALFRAME),0
					dd 0FFFFFFFFh xor (WS_EX_TOOLWINDOW or WS_EX_DLGMODALFRAME),0
					dd 0FFFFFFFFh xor (WS_DLGFRAME or WS_BORDER or DS_MODALFRAME),WS_BORDER
					dd 0FFFFFFFFh xor (WS_EX_TOOLWINDOW or WS_EX_DLGMODALFRAME),0
					dd 0FFFFFFFFh xor (WS_DLGFRAME or WS_BORDER or DS_MODALFRAME),WS_BORDER or WS_DLGFRAME
					dd 0FFFFFFFFh xor (WS_EX_TOOLWINDOW or WS_EX_DLGMODALFRAME),0
					dd 0FFFFFFFFh xor (WS_DLGFRAME or WS_BORDER or DS_MODALFRAME),WS_BORDER or WS_DLGFRAME
					dd 0FFFFFFFFh xor (WS_EX_TOOLWINDOW or WS_EX_DLGMODALFRAME),WS_EX_TOOLWINDOW
					dd 0FFFFFFFFh xor (WS_DLGFRAME or WS_BORDER or DS_MODALFRAME),WS_BORDER or WS_DLGFRAME or DS_MODALFRAME
					dd 0FFFFFFFFh xor (WS_EX_TOOLWINDOW or WS_EX_DLGMODALFRAME),WS_EX_DLGMODALFRAME
BordAll				db 'Flat,Boarder,Raised,Sunken,3D-Look,Edge',0
					dd 0FFFFFFFFh xor WS_BORDER,0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),0
					dd 0FFFFFFFFh xor WS_BORDER,WS_BORDER
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),0
					dd 0FFFFFFFFh xor WS_BORDER,0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),WS_EX_DLGMODALFRAME
					dd 0FFFFFFFFh xor WS_BORDER,0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),WS_EX_STATICEDGE
					dd 0FFFFFFFFh xor WS_BORDER,0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),WS_EX_CLIENTEDGE
					dd 0FFFFFFFFh xor WS_BORDER,0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),WS_EX_CLIENTEDGE or WS_EX_DLGMODALFRAME
BordStc				db 'Flat,Boarder,Raised,Sunken,3D-Look,Edge',0
					dd 0FFFFFFFFh xor (WS_BORDER or SS_SUNKEN),0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE),0
					dd 0FFFFFFFFh xor (WS_BORDER or SS_SUNKEN),WS_BORDER
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE),0
					dd 0FFFFFFFFh xor (WS_BORDER or SS_SUNKEN),0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE),WS_EX_DLGMODALFRAME
					dd 0FFFFFFFFh xor (WS_BORDER or SS_SUNKEN),SS_SUNKEN
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE),0
					dd 0FFFFFFFFh xor (WS_BORDER or SS_SUNKEN),0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE),WS_EX_CLIENTEDGE
					dd 0FFFFFFFFh xor WS_BORDER,0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE),WS_EX_CLIENTEDGE or WS_EX_DLGMODALFRAME
BordBtn				db 'Flat,Boarder,Raised,Sunken,3D-Look,Edge',0
					dd 0FFFFFFFFh xor (WS_BORDER or BS_FLAT),BS_FLAT
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),0
					dd 0FFFFFFFFh xor (WS_BORDER or BS_FLAT),WS_BORDER or BS_FLAT
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),0
					dd 0FFFFFFFFh xor (WS_BORDER or BS_FLAT),0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),WS_EX_DLGMODALFRAME
					dd 0FFFFFFFFh xor (WS_BORDER or BS_FLAT),0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),WS_EX_STATICEDGE
					dd 0FFFFFFFFh xor (WS_BORDER or BS_FLAT),0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),0
					dd 0FFFFFFFFh xor (WS_BORDER or BS_FLAT),0
					dd 0FFFFFFFFh xor (WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE or WS_EX_STATICEDGE),WS_EX_DLGMODALFRAME or WS_EX_CLIENTEDGE
TypeEdt				db 'Normal,Upper,Lower,Number,Password',0
					dd 0FFFFFFFFh xor (ES_UPPERCASE or ES_LOWERCASE or ES_PASSWORD or ES_NUMBER),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_UPPERCASE or ES_LOWERCASE or ES_PASSWORD or ES_NUMBER),ES_UPPERCASE
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_UPPERCASE or ES_LOWERCASE or ES_PASSWORD or ES_NUMBER),ES_LOWERCASE
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_UPPERCASE or ES_LOWERCASE or ES_PASSWORD or ES_NUMBER),ES_NUMBER
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_UPPERCASE or ES_LOWERCASE or ES_PASSWORD or ES_NUMBER),ES_PASSWORD
					dd 0FFFFFFFFh,0
TypeBtn				db 'Text,Bitmap,Icon',0
					dd 0FFFFFFFFh xor (BS_BITMAP or BS_ICON),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_BITMAP or BS_ICON),BS_BITMAP
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (BS_BITMAP or BS_ICON),BS_ICON
					dd 0FFFFFFFFh,0
TypeCbo				db 'DropDownCombo,DropDownList,SimpleCombo',0
					dd 0FFFFFFFFh xor (CBS_DROPDOWN or CBS_DROPDOWNLIST or CBS_SIMPLE),CBS_DROPDOWN
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (CBS_DROPDOWN or CBS_DROPDOWNLIST or CBS_SIMPLE),CBS_DROPDOWNLIST
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (CBS_DROPDOWN or CBS_DROPDOWNLIST or CBS_SIMPLE),CBS_SIMPLE
					dd 0FFFFFFFFh,0
TypeTrv				db 'NoLines,Lines,LinesAtRoot',0
					dd 0FFFFFFFFh xor (TVS_HASLINES or TVS_LINESATROOT),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (TVS_HASLINES or TVS_LINESATROOT),TVS_HASLINES
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (TVS_HASLINES or TVS_LINESATROOT),TVS_HASLINES or TVS_LINESATROOT
					dd 0FFFFFFFFh,0
TypeLsv				db 'Icon,List,Report,SmallIcon',0
					dd 0FFFFFFFFh xor LVS_TYPEMASK,LVS_ICON
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor LVS_TYPEMASK,LVS_LIST
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor LVS_TYPEMASK,LVS_REPORT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor LVS_TYPEMASK,LVS_SMALLICON
					dd 0FFFFFFFFh,0
TypeImg				db 'Bitmap,Icon',0
					dd 0FFFFFFFFh xor (SS_BITMAP or SS_ICON),SS_BITMAP
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (SS_BITMAP or SS_ICON),SS_ICON
					dd 0FFFFFFFFh,0
TypeDtp				db 'Normal,UpDown,CheckBox,Both',0
					dd 0FFFFFFFFh xor 03h,00h
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 03h,01h
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 03h,02h
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 03h,03h
					dd 0FFFFFFFFh,0
TypeStc				db 'BlackRect,GrayRect,WhiteRect,HollowRect,BlackFrame,GrayFrame,WhiteFrame,EtchedFrame,H-Line,V-Line',0
					dd 0FFFFFFFFh xor 1Fh,SS_BLACKRECT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_GRAYRECT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_WHITERECT
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_OWNERDRAW
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_BLACKFRAME
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_GRAYFRAME
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_WHITEFRAME
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_ETCHEDFRAME
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_ETCHEDHORZ
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 1Fh,SS_ETCHEDVERT
					dd 0FFFFFFFFh,0
AutoEdt				db 'None,Horizontal,Vertical,Both',0
					dd 0FFFFFFFFh xor (ES_AUTOHSCROLL or ES_AUTOVSCROLL),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_AUTOHSCROLL or ES_AUTOVSCROLL),ES_AUTOHSCROLL
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_AUTOHSCROLL or ES_AUTOVSCROLL),ES_AUTOVSCROLL
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (ES_AUTOHSCROLL or ES_AUTOVSCROLL),ES_AUTOHSCROLL or ES_AUTOVSCROLL
					dd 0FFFFFFFFh,0
FormDtp				db 'Short,Medium,Long,Time',0
					dd 0FFFFFFFFh xor 0Ch,00h
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 0Ch,0Ch
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 0Ch,04h
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor 0Ch,08h
					dd 0FFFFFFFFh,0
StarDlg				db 'Normal,CenterScreen,CenterMouse',0
					dd 0FFFFFFFFh xor (DS_CENTER or DS_CENTERMOUSE),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (DS_CENTER or DS_CENTERMOUSE),DS_CENTER
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (DS_CENTER or DS_CENTERMOUSE),DS_CENTERMOUSE
					dd 0FFFFFFFFh,0
OrieUdn				db 'Vertical,Horizontal',0
					dd 0FFFFFFFFh xor UDS_HORZ,0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor UDS_HORZ,UDS_HORZ
					dd 0FFFFFFFFh,0
OriePgb				db 'Horizontal,Vertical',0
					dd 0FFFFFFFFh xor PBS_VERTICAL,0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor PBS_VERTICAL,PBS_VERTICAL
					dd 0FFFFFFFFh,0
SortLsv				db 'None,Ascending,Descending',0
					dd 0FFFFFFFFh xor (LVS_SORTASCENDING or LVS_SORTDESCENDING),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (LVS_SORTASCENDING or LVS_SORTDESCENDING),LVS_SORTASCENDING
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (LVS_SORTASCENDING or LVS_SORTDESCENDING),LVS_SORTDESCENDING
					dd 0FFFFFFFFh,0
OwneCbo				db 'None,Fixed,Variable',0
					dd 0FFFFFFFFh xor (CBS_OWNERDRAWFIXED or CBS_OWNERDRAWVARIABLE),0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (CBS_OWNERDRAWFIXED or CBS_OWNERDRAWVARIABLE),CBS_OWNERDRAWFIXED
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor (CBS_OWNERDRAWFIXED or CBS_OWNERDRAWVARIABLE),CBS_OWNERDRAWVARIABLE
					dd 0FFFFFFFFh,0
ElliStc				db 'None,EndEllipsis,PathEllipsis,WordEllipsis',0
					dd 0FFFFFFFFh xor SS_ELLIPSISMASK,0
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor SS_ELLIPSISMASK,SS_ENDELLIPSIS
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor SS_ELLIPSISMASK,SS_PATHELLIPSIS
					dd 0FFFFFFFFh,0
					dd 0FFFFFFFFh xor SS_ELLIPSISMASK,SS_WORDELLIPSIS
					dd 0FFFFFFFFh,0
